...
export async function GET() {
  ...
  const { data: allCases } = await supabase
    .from('cases')
    .select('id,status,auto_cancel,estimate_amount,inquiry_date,event_date,company,event_name,media_id,event_category_id,floor_id,updated_at,cancel_reason_id,cancel_note')
